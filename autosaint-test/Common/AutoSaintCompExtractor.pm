...
# get reference_ids from idcdev and then get data from maui and idcdev
sub get_autosaint_reference_data
{
  ...
  # get connection on maui
  print "\nGet Connection on maui\n";
  my $maui_dbh = $self->_get_connection_on_db("maui","rmsuser","rmsuser");
