...
sub insert
{
  ...
  print "\nStart insertion of data related \n";

  foreach my $file (@sorted)
  {

    my $commandToRun = "sqlplus $self->{user}/$self->{password}\@$self->{database_name} < $file > $file.log";
