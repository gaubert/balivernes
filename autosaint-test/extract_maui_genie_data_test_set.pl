...
$ex->extract('IDCX.FPDESCRIPTION','IDCX.FPDESCRIPTION',\%TRANSHASH);
...
$ex->extract('RMSMAN.GARDS_DETECTORS','RMSMAN.GARDS_DETECTORS',\%TRANSHASH);

print "extract RMSMAN.GARDS_NUCL_LIB\n";

$ex->extract('RMSMAN.GARDS_NUCL_LIB','RMSMAN.GARDS_NUCL_LIB',\%TRANSHASH);

print "extract RMSMAN.GARDS_NUCL_LINES_LIB\n";

$ex->extract('RMSMAN.GARDS_NUCL_LINES_LIB','RMSMAN.GARDS_NUCL_LINES_LIB',\%TRANSHASH);

print "extract RMSMAN.GARDS_PRODUCT_TYPE\n";

$ex->extract('RMSMAN.GARDS_PRODUCT_TYPE','RMSMAN.GARDS_PRODUCT_TYPE',\%TRANSHASH);

print "extract RMSMAN.GARDS_RELEVANT_NUCLIDES\n";

$ex->extract('RMSMAN.GARDS_RELEVANT_NUCLIDES','RMSMAN.GARDS_RELEVANT_NUCLIDES',\%TRANSHASH);

print "extract RMSMAN.GARDS_STATIONS\n";

$ex->extract('RMSMAN.GARDS_STATIONS','RMSMAN.GARDS_STATIONS',\%TRANSHASH);
