...
#$GRIB_EXTRACTOR_HOME/bin/grib_extractor -c $STATION_LIST_1 -d /tmp/generated-test /ops/data/atm/primary-met/EN08*
#echo "second batch of stations"
#$GRIB_EXTRACTOR_HOME/bin/grib_extractor -d /tmp/generated-test -c $STATION_LIST_2 /ops/data/atm/primary-met/EN08*
echo "third batch of stations"
$GRIB_EXTRACTOR_HOME/bin/grib_extractor -c $STATION_LIST_3 -d . /ops/data/atm/primary-met/EN08082303
